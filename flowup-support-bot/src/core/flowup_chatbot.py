"""
FlowUp Chatbot - Système Simplifié et Efficace
Version finale optimisée pour les réponses aux UC
"""
...
class FlowUpChatbot:
    """Chatbot FlowUp simplifié et efficace"""
    ...
    def _detect_primary_uc(self, message: str) -> UCDetection:
        """Détecte l'UC principal dans le message"""
        best_uc = None
        best_confidence = 0.0
        best_keywords = []
